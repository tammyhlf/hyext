  ...
  render() {
    ...
    return (
      ...
      >
        ...
        >
          <View className="yellow-user">
            {score == otherScore ? null : dataObj.winner ==
              otherStreamerUnionId ? (
        ...
        >
          <View className="streamerName">
            ...
            <Text className="streamerScore-yellow">
              得分：{dataObj[otherStreamerUnionId]}
            </Text>
          </View>
          <View className="streamerName">
